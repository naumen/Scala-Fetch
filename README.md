...
Для реализации доступа к какому-либо источнику через Fetch требуется имплементировать для этого источника:
...
ZQuery и Fetch являются практическими реализациями статьи https://simonmar.github.io/bib/papers/haxl-icfp14.pdf , абстрактно описывающей (с привязкой к Хаскеллю) возможность программировать доступ к источникам данных на аппликативных функторах.
